    ...
    <div class="scroller">        
        <?php
            ...
            foreach ($response_data as $item) {
                    echo '<div class="partie"><div class="pays"><img src="./img/drapeau_svg/'. $item->pays .'.svg" class="imgpays"><h1 class="txtpays">'. $item->pays .'</h1></div><div class="marques"><a href="./template_marque.php?id='. $item->id .'"><div class="boutondiv"><img src="./img/logo_marque/'. $item->nom .'.svg" class="logoimg"></div></a></div><hr></div>';
                }
            }
